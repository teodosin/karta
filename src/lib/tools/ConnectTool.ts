...
} from '$lib/karta/ToolStore'; // Import from ToolStore
import { screenToCanvasCoordinates } from '$lib/karta/ViewportStore'; // Import from ViewportStore
...
export class ConnectTool implements Tool {
    ...
    onPointerDown(event: PointerEvent, targetElement: EventTarget | null): void {
        ...
        startConnectionProcess([nodeId]); // Pass the node ID in an array
