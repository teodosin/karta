...
pub fn create_router(state: AppState) -> Router<()> {
    ...
    let router = Router::new()
        ...
        .route("/api/edges", 
            ...
            .patch(edge_endpoints::reconnect_edge)
        )
...
pub async fn run_server(root_path: PathBuf) {
    run_server_with_logging(root_path, true).await;
}

pub async fn run_server_with_logging(root_path: PathBuf, init_logging: bool) {
    if init_logging {
